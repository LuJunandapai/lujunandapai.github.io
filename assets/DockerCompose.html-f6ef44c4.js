import{_ as l,p as i,q as p,s as n,R as s,t as e,Y as t,n as c}from"./framework-e1bed10d.js";const o={},r=n("h2",{id:"docker-远程访问",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-远程访问","aria-hidden":"true"},"#"),s(" Docker 远程访问")],-1),d=n("li",null,"建议增加证书连接 安全 | 没有密码暴露端口很危险",-1),u={href:"https://blog.csdn.net/hanxiaotongtong/article/details/124240589",target:"_blank",rel:"noopener noreferrer"},m=t(`<h3 id="配置-docker-设置" tabindex="-1"><a class="header-anchor" href="#配置-docker-设置" aria-hidden="true">#</a> 配置 Docker 设置</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1. 修改配置文件vim /usr/lib/systemd/system/docker.service，这是开启docker远程访问服务的第一步。0.0.0.0:2375表示在当前主机上所有网卡监听2375端口。修改ExecStart这行</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="设置-idea-连接" tabindex="-1"><a class="header-anchor" href="#设置-idea-连接" aria-hidden="true">#</a> 设置 IDEA 连接</h3><ul><li>在IDEA服务下进行配置Docker连接设置</li><li>TCP连接: 服务器的IP地址和Docker远程连接端口</li></ul><p><img src="https://apaiimages.oss-cn-guangzhou.aliyuncs.com/MD/image-20230322155327956.png" alt="image-20230322155327956"></p><h2 id="docker-远程证书访问" tabindex="-1"><a class="header-anchor" href="#docker-远程证书访问" aria-hidden="true">#</a> Docker 远程证书访问</h2>`,6),k=n("li",null,"开启证书校验远程连接比较安全 避免被黑挖矿 PS:亲身经历服务器差点被封了",-1),v={href:"https://blog.csdn.net/qq_34626094/article/details/130579470",target:"_blank",rel:"noopener noreferrer"},b={href:"https://blog.csdn.net/jimbooks/article/details/98037922",target:"_blank",rel:"noopener noreferrer"},g=t(`<h3 id="创建证书脚本" tabindex="-1"><a class="header-anchor" href="#创建证书脚本" aria-hidden="true">#</a> 创建证书脚本</h3><p>1.创建脚本</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建脚本文件 ca.sh</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.jsdelivr.net/gh/LuJunandapai/ApaiImage@main/MaYun-PicGo/image-20230703145632668.png" alt="image-20230703145632668"></p>`,15);function _(D,A){const a=c("ExternalLinkIcon");return i(),p("div",null,[r,n("ul",null,[d,n("li",null,[n("a",u,[s("Docker 远程访问参考"),e(a)])])]),m,n("ul",null,[k,n("li",null,[n("a",v,[s("Docker 远程证书访问"),e(a)]),s(),n("a",b,[s("执行脚本格式报错参考"),e(a)])])]),g,n("ul",null,[n("li",null,[n("a",h,[s("参考一"),e(a)])])]),f,n("blockquote",null,[n("p",null,[n("a",y,[s("Compose 服务编排参考"),e(a)]),s(),n("a",x,[s("基础参考"),e(a)])])]),q])}const N=l(o,[["render",_],["__file","DockerCompose.html.vue"]]);export{N as default};
